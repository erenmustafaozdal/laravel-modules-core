...
return [
    ...
    */
    ...
    'fields' => [
        'dealer_category' => [
            'name'                  => 'Kategori',
            'show_address'          => 'Ziyaretçilere Bayilerin Adresleri Gösterilsin mi?',
            'show_province'         => 'Ziyaretçilere Bayilerin İlleri Gösterilsin mi?',
            'show_county'           => 'Ziyaretçilere Bayilerin İlçeleri Gösterilsin mi?',
            'show_district'         => 'Ziyaretçilere Bayilerin Semtleri Gösterilsin mi?',
            'show_neighborhood'     => 'Ziyaretçilere Bayilerin Mahalleleri Gösterilsin mi?',
            'show_postal_code'      => 'Ziyaretçilere Bayilerin Posta Kodları Gösterilsin mi?',
            'show_land_phone'       => 'Ziyaretçilere Bayilerin Sabit Telefonları Gösterilsin mi?',
            'show_mobile_phone'     => 'Ziyaretçilere Bayilerin Cep Telefonları Gösterilsin mi?',
            'show_web'              => 'Ziyaretçilere Bayilerin İnternet Adresleri Gösterilsin mi?',
        ],
        'dealer' => [
            'name'                  => 'Ad',
            'address'               => 'Adres',
    ...
    'helpers' => [
        ...
        'dealer' => [
            ...
            'county_id'         => 'Bayinin bulunduğu ilçeyi seçin. <em class="label label-info">Bu alan il seçildiğinde aktif olacaktır.</em>',
            'district_id'       => 'Bayinin bulunduğu semti seçin. <em class="label label-info">Bu alan ilçe seçildiğinde aktif olacaktır.</em>',
            'neighborhood_id'   => 'Bayinin bulunduğu mahalleyi seçin. <em class="label label-info">Bu alan semt seçildiğinde aktif olacaktır.</em>',
            'postal_code_id'    => 'Bayinin bulunduğu mekanın posta kodu. <em class="label label-info">Bu alan mahalleyi seçtiğinde otomatik doldurulacaktır. Her hangi bir işlem yapmana gerek yok.</em>',
