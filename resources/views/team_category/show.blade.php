...
@section('title')
    {!! lmcTrans('laravel-team-module/admin.team_category.show') !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans('laravel-team-module/admin.team_category.show') !!}
        <small>
            {!! lmcTrans('laravel-team-module/admin.team_category.show_description', [
                'team_category' => $team_category->name
            ]) !!}
        </small>
    </h1>
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var showJs = "{!! lmcElixir('assets/pages/scripts/team_category/show.js') !!}";
        {{-- /js file path --}}
    ...
    <script src="{!! lmcElixir('assets/pages/js/loaders/team_category/show.js') !!}"></script>
    ...
    <div class="portlet light bordered mt-element-ribbon portlet-fit">
        ...
        <div class="portlet-title">
            ...
            <div class="actions pull-left">
                {!! getOps($team_category, 'show', false) !!}
            </div>
            {{-- /Actions --}}
        </div>
        {{-- /Portlet Title --}}
            ...
            <div class="row profile-account">
                ...
                <div class="col-md-3">
                    <ul class="ver-inline-menu tabbable margin-bottom-40">
                        ...
                        @if (Sentinel::getUser()->is_super_admin || Sentinel::hasAccess('admin.team_category.update'))
                        <li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="overview" class="tab-pane active">
                            <div class="profile-info">
                                @include('laravel-modules-core::team_category.partials.overview')
                            </div>
                        </div>
                        {{-- /Overview --}}
                        ...
                        <div id="edit_info" class="tab-pane form">
                            {!! Form::model($team_category,[
                                'method'    => 'PATCH',
                                'url'       => lmbRoute('admin.team_category.update', [ 'id' => $team_category->id ]),
                                'id'        => 'team_category-edit-info'
                            ]) !!}
