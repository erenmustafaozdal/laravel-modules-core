...
@section('title')
    {!! lmcTrans("ezelnet-frontend-module/admin.slider.{$operation}") !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans("ezelnet-frontend-module/admin.slider.{$operation}") !!}
        <small>
            {!! lmcTrans("ezelnet-frontend-module/admin.slider.{$operation}_description") !!}
        </small>
    </h1>
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var modelJs = "{!! lmcElixir('assets/pages/scripts/design_management/slider/operation.js') !!}";
        {{-- /js file path --}}
    ...
    <script src="{!! lmcElixir('assets/pages/js/loaders/design_management/slider/operation.js') !!}"></script>
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open([
                ...
                'url'   => lmbRoute('admin.slider.' . ($operation === 'edit' ? 'update' : 'store'), [
            ...
            {{-- Form Body --}}
            <div class="form-body">
                @include('laravel-modules-core::design_management.slider.partials.form', [
                    'columns'   => true
                ])
                @include('laravel-modules-core::design_management.slider.partials.detail_form')
            </div>
            {{-- /Form Body --}}
