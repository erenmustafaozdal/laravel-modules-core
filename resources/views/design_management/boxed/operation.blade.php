...
@section('title')
    {!! lmcTrans("ezelnet-frontend-module/admin.boxed.{$operation}") !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans("ezelnet-frontend-module/admin.boxed.{$operation}") !!}
        <small>
            {!! lmcTrans("ezelnet-frontend-module/admin.boxed.{$operation}_description") !!}
        </small>
    </h1>
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var aspectRatio = 1;
        var photoAspectRatio = '{!! config('ezelnet-frontend-module.boxed.uploads.photo.aspect_ratio.photo') !!}';
        var miniPhotoAspectRatio = '{!! config('ezelnet-frontend-module.boxed.uploads.photo.aspect_ratio.mini_photo') !!}';
        {{-- /languages --}}
    </script>
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open([
                ...
                'url'   => lmbRoute('admin.boxed.' . ($operation === 'edit' ? 'update' : 'store'), [
