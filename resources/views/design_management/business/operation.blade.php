...
@section('title')
    {!! lmcTrans("ezelnet-frontend-module/admin.business.{$operation}") !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans("ezelnet-frontend-module/admin.business.{$operation}") !!}
        <small>
            {!! lmcTrans("ezelnet-frontend-module/admin.business.{$operation}_description") !!}
        </small>
    </h1>
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        {{-- languages --}}
        var messagesOfRules = {
            'photo[photo]': { required: "{!! LMCValidation::getMessage('photo','required') !!}" },
        ...
        var aspectRatio = 1;
        var photoAspectRatio = '{!! config('ezelnet-frontend-module.business.uploads.photo.aspect_ratio.photo') !!}';
        var miniPhotoAspectRatio = '{!! config('ezelnet-frontend-module.business.uploads.photo.aspect_ratio.mini_photo') !!}';
        {{-- /languages --}}
    </script>
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            {!! Form::open([
                ...
                'url'   => lmbRoute('admin.business.' . ($operation === 'edit' ? 'update' : 'store'), [
