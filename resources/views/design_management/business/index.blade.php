                ...
                <table class="table table-striped table-bordered table-hover table-checkable lmcDataTable">
                    <thead>
                        <tr role="row" class="heading">
                            ...
                            <th class="all" width="20%"> {!! lmcTrans('ezelnet-frontend-module/admin.fields.design_management.mini_photo') !!} </th>
                            <th class="all" width="10%"> {!! lmcTrans('ezelnet-frontend-module/admin.fields.design_management.title') !!} </th>
