...
@section('title')
    {!! lmcTrans('laravel-product-module/admin.product_showcase.show') !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans('laravel-product-module/admin.product_showcase.show') !!}
        <small>
            {!! lmcTrans('laravel-product-module/admin.product_showcase.show_description', [
                'product_showcase' => $product_showcase->name
            ]) !!}
        </small>
    </h1>
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var showJs = "{!! lmcElixir('assets/pages/scripts/product_showcase/show.js') !!}";
        {{-- /js file path --}}
    ...
    <script src="{!! lmcElixir('assets/pages/js/loaders/product_showcase/show.js') !!}"></script>
    ...
    <div class="portlet light bordered mt-element-ribbon portlet-fit">
        ...
        <div class="portlet-title">
            ...
            <div class="actions pull-left">
                {!! getOps($product_showcase, 'show', false) !!}
            </div>
            {{-- /Actions --}}
        </div>
        {{-- /Portlet Title --}}
            ...
            <div class="row profile-account">
                ...
                <div class="col-md-3">
                    <ul class="ver-inline-menu tabbable margin-bottom-40">
                        ...
                        @if (Sentinel::getUser()->is_super_admin || Sentinel::hasAccess('admin.product_showcase.update'))
                            <li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="overview" class="tab-pane active">
                            <div class="profile-info">
                                @include('laravel-modules-core::product_showcase.partials.overview')
                            </div>
                        </div>
                        {{-- /Overview --}}
