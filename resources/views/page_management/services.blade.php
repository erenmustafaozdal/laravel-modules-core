...
@section('title')
    {!! lmcTrans('ezelnet-frontend-module/admin.page_management.services') !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans('ezelnet-frontend-module/admin.page_management.services') !!}
        <small>
            {!! lmcTrans('ezelnet-frontend-module/admin.page_management.services_description') !!}
        </small>
    </h1>
@endsection
            ...
            @if( ! $pages->isEmpty())
                ...
                <div class="form-body">
                    ...
                    @foreach($pages as $page)
                        ...
                        @include('laravel-modules-core::page_management.partials.page_option_direction')
                    @endforeach
