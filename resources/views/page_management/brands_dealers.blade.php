...
@section('title')
    {!! lmcTrans('ezelnet-frontend-module/admin.page_management.brands_dealers') !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans('ezelnet-frontend-module/admin.page_management.brands_dealers') !!}
        <small>
            {!! lmcTrans('ezelnet-frontend-module/admin.page_management.brands_dealers_description') !!}
        </small>
    </h1>
@endsection
