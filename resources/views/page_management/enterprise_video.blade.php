...
@section('title')
    {!! lmcTrans('ezelnet-frontend-module/admin.page_management.enterprise_video') !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans('ezelnet-frontend-module/admin.page_management.enterprise_video') !!}
        <small>
            {!! lmcTrans('ezelnet-frontend-module/admin.page_management.enterprise_video_description') !!}
        </small>
    </h1>
@endsection
                ...
                <div class="form-body">
                    ...
                    @foreach($pages as $page)
                        ...
                        @include('laravel-modules-core::page_management.partials.page_option_item_count',[
                            'counts'    => config('ezelnet-frontend-module.page_item_count.gallery')
                        ])
                    @endforeach
