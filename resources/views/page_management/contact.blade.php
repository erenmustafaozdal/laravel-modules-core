...
@section('title')
    {!! lmcTrans('ezelnet-frontend-module/admin.page_management.contact') !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans('ezelnet-frontend-module/admin.page_management.contact') !!}
        <small>
            {!! lmcTrans('ezelnet-frontend-module/admin.page_management.contact_description') !!}
        </small>
    </h1>
@endsection
            ...
            @if( ! $pages->isEmpty())
                ...
                <div class="form-body">
                    ...
                    @foreach($pages as $page)
                        ...
                        @include('laravel-modules-core::page_management.partials.page_option_form_is_active')
                    @endforeach
