...
@section('title')
    {!! lmcTrans('ezelnet-frontend-module/admin.page_management.media_we_photo') !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans('ezelnet-frontend-module/admin.page_management.media_we_photo') !!}
        <small>
            {!! lmcTrans('ezelnet-frontend-module/admin.page_management.media_we_photo_description') !!}
        </small>
    </h1>
@endsection
