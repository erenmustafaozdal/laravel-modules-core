...
@section('title')
    {!! lmcTrans('ezelnet-frontend-module/admin.page_management.media_we_video') !!}
@endsection
...
@section('page-title')
    <h1>
        {!! lmcTrans('ezelnet-frontend-module/admin.page_management.media_we_video') !!}
        <small>
            {!! lmcTrans('ezelnet-frontend-module/admin.page_management.media_we_video_description') !!}
        </small>
    </h1>
@endsection
