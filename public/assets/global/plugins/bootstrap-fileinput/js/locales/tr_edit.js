...
(function ($) {
    ...
    $.fn.fileinputLocales['tr'] = {
        ...
        previewZoomButtonTitles: {
            ...
            toggleheader: 'Başlığın durumunu değiştir',
            fullscreen: 'Tam ekran durumunu değiştir',
            borderless: 'Kenarsızlık modu durumunu değiştir',
            close: 'Detay önizlemeyi kapat'
        }
    };
})(window.jQuery);
