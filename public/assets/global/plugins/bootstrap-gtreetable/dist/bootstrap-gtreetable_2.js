        ...
        getSourceNodes: function (nodeId, force) {
            ...
            var defaultSourceOptions = {
                ...
                error: function (XMLHttpRequest) {
                    bootbox.alert(XMLHttpRequest.status + ': ' + XMLHttpRequest.responseText);
                },
                complete: function () {
                    if (nodeId > 0) {
    ...
    GTreeTableNode.prototype = {
        ...
        add: function (position, type) {
            ...
            if (!canAddData.result) {
                bootbox.alert(canAddData.message);
                return false;
            }
        ...
        move: function(oDestination, position) {            
            ...
            if (moveData.result === false) {
                bootbox.alert(moveData.message);
                return false;
            }
    ...
    $.fn.gtreetable.defaults = {
        ...
        defaultActions: [
            ...
            },
            {
                name: '${delete}',
                event: function (oNode, oManager) {
                    bootbox.confirm(oManager.language.messages.onDelete, function(r)
                    {
                        if (r) {
                            oNode.remove();
                        }
