...
var Home = {
    ...
    init: function () {
        ...
        LMCFileinput.init(this.getPhotoHomeImageBannerFirstOptions());
        LMCFileinput.init(this.getPhotoHomeImageBannerSecondOptions());
     ...
     * get default photo fileinput options
     */
    getPhotoHomeImageBannerFirstOptions: function()
    {
        return {
            src: '.photo_home_image_banner_first',
            formSrc:  'form.form',
            aspectRatio: homeImageBannerAspectRatio,
            fileinput: {
                maxFileSize: maxSize,
     ...
     * get default photo fileinput options
     */
    getPhotoHomeImageBannerSecondOptions: function()
    {
        return {
            src: '.photo_home_image_banner_second',
            formSrc:  'form.form',
            aspectRatio: homeImageBannerAspectRatio,
            fileinput: {
                maxFileSize: maxSize,
