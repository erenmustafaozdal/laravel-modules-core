                ...
                fileinput: {
                    ...
                    uploadExtraData: function (previewId, index) {
                        ...
                        return {
                            ...
                            'photo[x]': $("input[name='x[]']").map(function(){return $(this).val();}).get(),
                            'photo[y]': $("input[name='y[]']").map(function(){return $(this).val();}).get(),
                            'photo[width]': $("input[name='width[]']").map(function(){return $(this).val();}).get(),
                            'photo[height]': $("input[name='height[]']").map(function(){return $(this).val();}).get()
                        };
                    },
                    ajaxSettings: {
                        success: function(data)
