...
// fotoğraf kırpma sorunu aşmak için geçici bir çözümdür
// resize içine de fonksiyon çalıştırması konmuştur
var productHeightResize = function() {
	if ($('a.product-image img').length > 0) {
		$('a.product-image img').each(function (key, item) {
