...
var LMCApp = {
    ...
    lang: {
        ...
        admin: {
            ops: {
                ...
                destroy_input_confirm: 'Kayıt, form bilgileri arasından silinecek! Bu işlem formu göndermeden bir değişikliğe yol açmaz...<br> Silmek istediğine emin misin?',
                destroy: 'Sil',
    ...
    resetAllFormFields: function(target)
    {
        ...
        // icheck
        if ($('.icheck', target).length) {
            $('.icheck', target).iCheck('uncheck').iCheck('update');
        }
